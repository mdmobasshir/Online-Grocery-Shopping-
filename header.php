...
<body>
    ...
    <div class="agileits_header">
      <div class="w3l_offers"> <a href="#"> Projectworlds Grocery shopping</a> </div>
      ...
      <div class="container">
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+919979331605">(+91) 7000830947</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:store@grocery.com"> <a href="mailto:store@grocery.com">storegrocery@gmail.com</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
